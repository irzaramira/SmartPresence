...
@section('pageTitle', 'Registered Dosen')
    ...
    <div class="container">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a class="btn btn-danger"
                                                href="/userregistered/dosen/{{ $user->id }}/delete">Yes</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="modal fade" id="adduser" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title font-weight-bold">Add Dosen</h4>
                    </div>
                    <div class="modal-body">
                        <form action="/userregistered/dosen/add/success" method="POST">
                            @csrf
                            <div>
